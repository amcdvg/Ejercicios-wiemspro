...
from utils._utils import valid_full_pose, valid_keypoints, calculate_angle
import numpy as np
import time
...
class ReverseFlyExercise(Exercise):
    ...
    def draw(self, frame):
        """
        Dibuja la interfaz para el ejercicio de PájaroBanco en el frame.
        Se muestra el nombre del ejercicio, el contador de repeticiones, la fase actual y el ángulo calculado.
        """
